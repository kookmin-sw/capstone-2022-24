...
class Payment(models.Model):
    ...
    request_date_time = models.DateTimeField(default=timezone.now, db_column="requestDateTime")
    approval_date_time = models.DateTimeField(null=True, blank=True, db_column="approvalDateTime")
