        ...
        value=(
            {
                ...
                "status": "Recruiting",
                "timeStamps": {"applyDateTime": "2022-05-31 06:38:08"},
                "role": "member",
                "id": None,
                "account": None,
                "report": None,
        ...
        value=(
            {
                ...
                "fellows": [
                    {"id": 4, "nickname": "string", "profileImageUrl": None, "isLeader": True, "isMyself": False},
                    {
                        "id": 2,
                        "nickname": "캡스톤",
                        "profileImageUrl": "https://shop3.daumcdn.net/thumb/R500x500/?fname=http%3A%2F%2Fshop3.daumcdn."
                        "net%2Fshophow%2Fp%2FS16182251276.jpg%3Fut%3D20220129023802",
                        "isLeader": False,
                        "isMyself": False,
                    },
                    {"id": 1, "nickname": "ongot", "profileImageUrl": None, "isLeader": False, "isMyself": True},
                ],
                "report": {"reportedGroup": True, "reportedLeader": False, "reportCount": 1, "leaderReportCount": 0},
            }
        ),
    ),
    OpenApiExample(
        name="Success Example (200, Recruited, Leader Myself)",
        response_only=True,
        value=(
            {
                "id": 2,
                ...
                "report": {"reportedGroup": True, "reportedLeader": None, "reportCount": 1, "leaderReportCount": 0},
            }
        ),
    ),
]
