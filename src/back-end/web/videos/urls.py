...
from watching_marks.views import WatchingMarkCreateAndDestroyView
...
urlpatterns = [
    ...
    path("<int:video_id>/watch-marks/", WatchingMarkCreateAndDestroyView.as_view(), name="video_watching_mark"),
]
