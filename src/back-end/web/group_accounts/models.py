...
class GroupAccount(models.Model):
    ...
    creation_date_time = models.DateTimeField(null=True, blank=True, db_column="creationDateTime")
    last_modification_date_time = models.DateTimeField(null=True, blank=True, db_column="lastModificationDateTime")

    class Meta:
        """Metadata of GroupAccount model"""
